...
<div class="container-fluid card">
    ...
    <div class="card-body">
        <form action="{{ route('trip-ticket.store') }}" method="POST" id="formPr">
            @csrf
            ...
            <div class="row mt-2">
                <div class="col">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" name="place_to_visit" placeholder="Place to be visited" class="form-control" value="{{ old('place_to_visit') }}">
                    </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="number" name="amount" placeholder="Others Amount" class="form-control" value="{{ old('amount') }}">
                    </div>
                    @error('amount')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="col">
                    ...
                    @enderror
                            <div class="form-group mt-2">
                                ...
                                <input type="text" name="driver" placeholder="Driver" class="form-control" value="{{ old('driver') }}">
                            </div>
                            @error('driver')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        <div class="row">
                            <div class="col">
                                <div class="form-group mt-2">
                                    ...
                                    <input type="text" name="passenger" placeholder="Passenger" class="form-control" value="{{ old('passenger') }}" >
                                </div>
                                @error('passenger')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <div class="col form-group mt-2">
                            ...
                            <select name="gas_type" id="" class="select2 form-select">
                                ...
                                <option value="1" {{ old('gas_type') == 1 ? 'selected' : '' }} >Regular</option>
                                <option value="2" {{ old('gas_type') == 2 ? 'selected' : '' }} >Unleaded</option>
                                <option value="3" {{ old('gas_type') == 3 ? 'selected' : '' }} >Diesel</option>
                            </select>
                        </div>
                        @error('gas_type')
                        <small class="text-danger">{{ $message }}</small>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <textarea name="purpose" class="form-control" rows="1" placeholder="Purpose">{{ old('purpose') }}</textarea>
                    </div>
                    @error('purspose')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group mt-2">
                                ...
                                <input name="start_time" class="form-control" type="time" value="{{ old('start_time') }}"  />
                            </div>
                            @error('purspose')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="number" name="oil_issued" class="form-control" placeholder="Oil Issued" value="{{ old('oil_issued') }}" >
                    </div>
                    @error('oil_issued')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
