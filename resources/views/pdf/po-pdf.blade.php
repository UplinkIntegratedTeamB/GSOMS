        ...
        <table style="border-collapse: collapse; margin: 0 auto ">
            <thead>
                ...
                <tr>
                    ...
                    <td colspan="5" style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">{{ $pos->requestDetail->abstractCanvass->winners->name }}</td>
                ...
                <tr>
                    ...
                    <td colspan="5" style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">{{ $pos->requestDetail->abstractCanvass->winners->address }}</td>
                ...
                <tr>
                    ...
                    <td colspan="2" style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">Mode of Procurement: <br>
                ...
                <tr>
                    ...
                    <td style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">
                        {{ $pos->no_of_days }}
                    </td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">{{ $po->item->id }}</td>
                    <td style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">{{ $po->item->quantity }}</td>
                    <td style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">{{ $po->item->unit->description }}</td>
                    <td colspan="3" style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">{{ $po->description }}</td>
                    <td style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">{{ number_format($po->unit_price, 2) }}</td>
                    <td style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start">{{ number_format($po->estimated_cost, 2) }}</td>
                </tr>
                @endforeach
                <tr>
                    <td style="border: 1px solid black; font-size: 12px; padding: 5px; text-align: start"></td>
