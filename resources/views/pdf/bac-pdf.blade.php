...
<body>
    ...
    <div class="" style="height: 15rem">
        ...
        <div class="container" style="margin-top: 40px; font-size: 14px;">
            <label for="" style="margin-left: 3em">Done</label> this <label for="" style="text-decoration: underline">{{ \Carbon\Carbon::parse($resolution->created_at)->format('jS') }}</label> day of <label for="" style="text-decoration: underline"> {{ \Carbon\Carbon::parse($resolution->created_at)->format('F, Y') }} </label> at Santa Cruz Laguna
        </div>

        <div class="outer-container" style="margin-top: 6%">
            <p class="text-center">
                <label for="" style="font-size: 13px; font-weight: 600">MELVIN O. BONZA</label> <br> Municipal Administrator <br> <i>BAC - Chairman</i>
            </p>
            <p class="text-center">
                <label for="" style="font-size: 13px; font-weight: 600">ATTY. RONALDO C. MARIANO</label> <br> Municipal Legal Officer <br> <i>BAC - Vice Chairman</i>
            </p>
        </div>

        <div class="outer-container" style="margin-top: 6%">
            <p class="text-center">
                <label for="" style="font-size: 13px; font-weight: 600">ENGR. PABLO M. MAGPILY JR.</label> <br> Municipal Engineer <br> <i>Member</i>
            </p>
            <p class="text-center">
                <label for="" style="font-size: 13px; font-weight: 600">EnP. JOSHUA FEDERICK J. VITALIZ, DLUP</label> <br> MGDH I-LDRRMO <br> <i>Member</i>
            </p>
            <p class="text-center">
                <label for="" style="font-size: 13px; font-weight: 600">EILEEN S. TALABIS</label> <br> Municipal Budget Officer <br> <i>Member</i>
            </p>
        </div>
