...
<div class="container-fluid ">
    <div class="card py-5">
        ...
        <form action="{{ route('abstract-bid.store', $id) }}" method="POST">
            @csrf
            <div class="card-body row">
                <div class="col">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <div class="input-group">
                            <textarea name="purpose" class="form-control" rows="1" placeholder="Purpose" required>{{ $requests->purpose }}</textarea>
                        </div>
                    </div>
                    @error('purpose')
                    ...
                    <div class="form-group mt-2">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" value="" min="1" name="cash_bond" placeholder="Cash Bond" required>
                        </div>
                    </div>
                    @error('cash_bond')
                        <div class="text-danger">{{ $message }}</div>
                ...
                <div class="col">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <div class="input-group">
                            <input type="text" readonly class="form-control" value="{{ date('F j, Y', strtotime($requests->created_at)) }}">
                        </div>
                    </div>
                    <div class="form-group mt-2">
                        <label for="">Evaluated Budget Cost</label>
                        <div class="input-group">
                            <input type="text" class="form-control" value="{{ number_format($requests->grand_total, 2) }}" readonly>
                        </div>
                    </div>
                </div>
