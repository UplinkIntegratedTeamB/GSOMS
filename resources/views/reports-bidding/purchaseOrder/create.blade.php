...
<div class="container-fluid">
    <div class="card">
        ...
        <form action="{{ route('po-bid.store', $id) }}" method="POST" id="formPr">
            @csrf
            <div class="card-body row">
                <div class="col">
                    <input type="text" hidden value="{{ $requests->id }}" name="request_detail_id">
                    <div class="form-group">
                        <label for="">P.O No.</label>
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="P.O No." name="" value="{{ $cFormat }}" readonly>
                        </div>
                    </div>
                    <div class="form-group mt-2">
                        <label for="">Department</label>
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Office/Department" value="{{ $requests->department->name }}" readonly>
                        </div>
                    </div>
                    <div class="form-group mt-2">
                ...
                <div class="col mb-5">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="PR No." value="{{ $requests->pr_no }}" name="" readonly>
                        </div>
                    </div>
                    <div class="form-group mt-2">
                        <label for="">Section</label>
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="No Section Selected" value="{{ $requests->section?->name }}" readonly>
                        </div>
                    </div>
                    <div class="form-group mt-2">
                        <label for="">Place of Delivery</label>
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Place of Delivery" value="{{ $requests->endUserOffice->name }}" readonly>
                        </div>
                    </div>
