...
<div class="container-fluid card">
    ...
    <div class="card-body">
    <form action="{{ route('invitation.store', $id) }}" method="POST" id="formPr">
            @csrf
            <div class="row">
                <div class="col">
                    <div class="form-group ">
                        <label for="">Issuance of Bid Document</label>
                        <input type="date" name="issuance_of_bid" class="form-control">
                    </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="date" class="form-control" name="pre_procurement" placeholder="Number of Days">
                    </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="number" class="form-control" name="day" placeholder="Number of Days">
                    </div>
                    @error('date')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="date" name="opening_of_bids" class="form-control">
                    </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="date" name="pre_bid" class="form-control">
                    </div>
                    @error('pre_bid')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                    <div class="form-group mt-2">
                        ...
                        <input type="date" name="bid_evaluation" class="form-control">
                    </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="date" name="post_qualification" class="form-control">
                    </div>
