...
<div class="container-fluid ">
    <div class="card py-5">
        ...
        <div class="card-body row">
            <div class="col">
                ...
                <div class="form-group mt-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" readonly value="{{ date('F j, Y', strtotime($abstracts->requestDetail->created_at)) }}">
                ...
                <table class="table table-striped table-hover" id="dtable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('abstract.removeItem', $request->id) }}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal1" id="viewBtn" data-id="{{ $abstracts->id }}" data-offered="{{ $request->id }}"><i class="fas fa-eye"></i></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
            <form id="updateForm" action="{{ route('abstract.update', ':id') }}" method="POST">
                @csrf
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
        ...
        <div class="m-3">
            <a href="{{ route('abstract.compute', $id) }}" style="float: right" type="button" onclick="confirmSave(event)" class="btn btn-primary">Compute</a>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        $('#dtable').on('click', "#viewBtn", function() {
            fetch("{{ config('app.url') }}" + '/abstract/' + $(this).data('id'))
                    ...
                    if (abstract.supplier_offereds) {
                        ...
                        abstract.supplier_offereds.forEach(function(firstSupplierOffered, idx) {
                            ...
                            if (firstSupplierOffered.id == offers) {
                                firstSupplierOffered.supplier_offered_items.forEach(function(item, index) {
                                    if (offers == item.supplier_offered_id) {
