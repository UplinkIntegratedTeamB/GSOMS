...
<div class="container-fluid">
    <div class="card">
        ...
        <form action="{{ route('po.update', $pos->purchaseOrder->id) }}" method="POST" id="formPr">
            @csrf
                ...
                <div class="col">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="P.O No." name="" value="{{ $pos->purchaseOrder->po_no }}" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="input-group">
                                <input type="date" class="form-control" name="confirm_date" value="{{ date('Y-m-d', strtotime($pos->purchaseOrder->confirm_date))  }}" autofocus>
                            </div>
                        </div>
                        <div class="col">
                            <label for="">Delivery Date</label>
                            <div class="input-group">
                                <input type="date" name="delivery_date" value="{{ date('Y-m-d', strtotime($pos->purchaseOrder->delivery_date)) }}" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col mb-5">
                    ...
                    <div class="form-group">
                        ...
                        <select name="payment_term" class="select2 form-control" id="">
                            ...
                            <option value="Cash on Delivery" {{ $pos->purchaseOrder->payment_term === 'Cash on Delivery' ? 'selected' : '' }}>Cash on Delivery</option>
                            <option value="Online Payment" {{ $pos->purchaseOrder->payment_term === 'Online Payment' ? 'selected' : '' }}>Online Payment</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="No. of Days" name="no_of_days" value="{{ $pos->purchaseOrder->no_of_days }}" autofocus>
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <select name="delivery_term" id="" class="select2 form-control">
                                ...
                                <option value="1" {{ $pos->purchaseOrder->delivery_term === '1' ? 'selected' : '' }}>Pick-up</option>
                                <option value="2" {{ $pos->purchaseOrder->delivery_term === '2' ? 'selected' : '' }}>Delivery w/in Calendar days from receipt of PO</option>
                                <option value="3" {{ $pos->purchaseOrder->delivery_term === '3' ? 'selected' : '' }}>As per schedule</option>
                            </select>
