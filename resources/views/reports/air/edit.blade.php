...
<div class="container-fluid card">
    ...
    <form action="{{ route('air.update', $details->acceptanceInspection->id) }}" method="POST" id="formPr">
        @csrf
        <div class="card-body row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" name="c_number" class="form-control" readonly value="{{ $details->acceptanceInspection->c_number }}">
                    </div>
                </div>
                ...
                <div class="form-group mt-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="invoice_no" value="{{ $details->acceptanceInspection->invoice_no }}">
                    </div>
                </div>
                <div class="form-group mt-2">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" value="{{ $details->acceptanceInspection->obr_no }}" name="obr_no">
                    </div>
                </div>
                <div class="form-group mt-2">
                ...
                <div class="form-group mt-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" readonly value="{{ $details->abstractCanvass->winners->name }}">
                    </div>
                </div>
            </div>
            <div class="mt-3">
