...
<body>
    ...
    <label for="">Date of Canvass: {{ date('F, j, Y', strtotime($abstracts->requestDetail->bidInvitation->until) ) }}</label> <br>
        ...
        <table style="border-collapse: collapse; margin: 0 auto ">
            ...
            <tbody>
                ...
                <tr style="text-align: start">
                    <td colspan="5" style="border: 1px solid black; font-size: 12px; padding: 10px; text-align: start;">{{ $det['item_description'] }}</td>
                ...
                @endforeach
                <tr style="text-align: start">
                    <td colspan="5" style="border: 1px solid black; font-size: 12px; padding: 10px; text-align: end;">Total</td>
                    <td colspan="" style="border: 1px solid black; font-size: 12px;"></td>
                    <td colspan="" style="border: 1px solid black; font-size: 12px;"></td>
                    @foreach ($det['data'] as $x)
