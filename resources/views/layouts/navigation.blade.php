        ...
        <div class="multi-level collapse" role="list" id="submenu-appShopping" aria-expanded="false">
            <ul class="flex-column nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="multi-level collapse" role="list" id="submenu-appICS" aria-expanded="false">
                        <ul class="flex-column nav">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('ics.index') }}">
                                    <span class="sidebar-icon">
                                        <i class="fas fa-file-pdf"></i>
                                    </span>
                                    <span class="sidebar-text">Create ICS</span>
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="multi-level collapse" role="list" id="submenu-appPAR" aria-expanded="false">
                        <ul class="flex-column nav">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('par.index') }}">
                                    <span class="sidebar-icon">
                                        <i class="fas fa-file-pdf"></i>
                                    </span>
                                    <span class="sidebar-text">Create PAR</span>
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="multi-level collapse" role="list" id="submenu-appRIS" aria-expanded="false">
                        <ul class="flex-column nav">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('ris.index') }}">
                                    <span class="sidebar-icon">
                                        <i class="fas fa-file-pdf"></i>
                                    </span>
                                    <span class="sidebar-text">Create RIS</span>
                                </a>
                            </li>
                            <li class="nav-item">
