...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Department::insert([
            ...
            ['department_code' => null, 'name' => 'MGSO', 'expense_type_id' => null, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['department_code' => null, 'name' => 'MPDO', 'expense_type_id' => null, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['department_code' => null, 'name' => "Deped" , 'expense_type_id' => null, 'created_at' => $now, 'updated_at' => $now ],
            ['department_code' => null, 'name' => "ACS/Deped" , 'expense_type_id' => null, 'created_at' => $now, 'updated_at' => $now ],
            ['department_code' => null, 'name' => "LEGAL" , 'expense_type_id' => null, 'created_at' => $now, 'updated_at' => $now ],
            ['department_code' => null, 'name' => "MNAO" , 'expense_type_id' => null, 'created_at' => $now, 'updated_at' => $now ],
            ['department_code' => null, 'name' => "SCTMO" , 'expense_type_id' => null, 'created_at' => $now, 'updated_at' => $now ],
            ['department_code' => null, 'name' => 'MDRRMO', 'expense_type_id' => null, 'created_at' => $now, 'updated_at' => $now],
